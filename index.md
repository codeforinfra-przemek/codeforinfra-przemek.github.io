...
Buduję rozwiązania w obszarze [tu wpisz: SRE / DevOps / platform engineering / ...].

Na tej stronie znajdziesz:

- **Case study** – konkretne projekty, które dowiozłem
- **Deep-dive / technical write-up** – wgryzienia się w tematy techniczne
- **Engineering story** – jak podchodziłem do problemów
- **Postmortem** – co poszło nie tak i czego się nauczyłem

## Artykuły

- [Przykładowe case study](case-study-gha-migration.md)
