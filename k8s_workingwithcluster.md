...
```
#Log into the control plane node c1-cp1
ssh aen@c1-cp1
...
#Is the resource in a namespace, for example StorageClass isn't and is available to all namespaces
#and finally Kind...this is the object type.
...
#We can easily filter using grep
